...
<body>
<h2>~~添加填空题~~</h2>
<form action="<%=request.getContextPath()%>/question/addFill" method="post">
    <div id="a1">
        <label>题目内容</label><br>
        <textarea name="title"  cols="130" rows="6"></textarea><br><br>
        <span><textarea name="answer" cols="30" rows="4" placeholder="第一空答案"></textarea></span>
        <span><textarea name="answer"  cols="30" rows="4"  placeholder="第二空答案"></textarea></span>
        <span><textarea name="answer"  cols="30" rows="4" placeholder="第三空答案"></textarea></span>
        <span><textarea name="answer"  cols="30" rows="4" placeholder="第四空答案"></textarea></span>
        <br>
