...
<%@ page import="com.tju.examsystem.domain.PaperStudent" %>
...
<head>
    ...
    <style type="text/css">
        ...
        #a2{width: 45%;height: 40px;float: left;text-align: right;padding-top: 35px;}
...
<div id="a2" >
    <span id="average-score">平均分：<%=request.getAttribute("aver")%></span>
</div>
<div class="table" style="height: 450px; overflow: auto;">
    <table border="1" style="text-align:center" id="table" cellspacing="0">
        ...
        <%
            List<PaperStudent> grades = (List<PaperStudent>) request.getAttribute("grades");
            int i=0;
